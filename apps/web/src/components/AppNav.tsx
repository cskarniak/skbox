...
import { IconSmartHome, IconScript, IconApps, IconSettings, IconDevicesPc, IconAlertTriangle } from '@tabler/icons-react';
import { useRouter } from 'next/navigation';

export type AppNavTab = 'devices' | 'appareils' | 'scenarios' | 'alarms' | 'modules' | 'settings';
  ...
  return (
    <Tabs
      ...
      onChange={(v) => {
        ...
        if (v === 'alarms') router.push('/alarms');
    ...
    >
      <Tabs.List style={{ flexWrap: 'nowrap' }}>
        ...
        <Tabs.Tab value="alarms" leftSection={<IconAlertTriangle size={16} />}>
          <Box visibleFrom="sm">Alarmes</Box>
        </Tabs.Tab>
